...
auto union = bgrms1 + bgrms2;                                 // 2  bigrams union
auto union = bigrams::unite(bgrms1, bgrms2, ...);             // 2+ bigrams union
...
for bigram, cnt in bgrms1:              # Bigrams are tuple[bigram, count] generators
